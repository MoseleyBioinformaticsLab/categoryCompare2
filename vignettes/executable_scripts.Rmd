---
title: "categoryCompare2 Scripts"
...
to document what these scripts do. The scripts are found in the folder `executables`
from the package directory.

You can run the `install_executables` function to move the scripts somewhere more
useful, or `list_executables` to provide the locations of the scripts so that you
...
and comparisons between them using `categoryCompare2.R`.
