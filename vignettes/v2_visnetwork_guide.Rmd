...
% \VignetteDepends{categoryCompare2, GO.db, affy, hgu95av2.db, genefilter, estrogen, limma, DiagrammeR, visNetwork, ragg}
...
```{r normalizeAffy, message=FALSE, eval=FALSE}
eData <- rma(a)
```
