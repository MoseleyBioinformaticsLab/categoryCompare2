...
filter_and_group.R --enrichment-results=example_enrichment.txt \
  --p-cutoff=0.01 --count-cutoff=2 --group=TRUE --similarity-cutoff=0.8 \
...
Let's go through all of the options:
  ...
  * --group: should grouping of annotations be attempted [default: TRUE]
...
If you feel that the CLI is too slow for iterating parameters, you may want to work within R itself, where you can iterate on the graph structure itself.
