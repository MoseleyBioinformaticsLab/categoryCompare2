...
at the categorical level. Categorical data includes any gene annotation,
...
And we can generate a legend so we know which colors correspond to which
group.
...
![](v2_guide_files/figure-html/bp_legend-1.png)
