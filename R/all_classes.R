...
#' @exportMethod show
#' @rdname annotation
setMethod("show", signature = list(object = "annotation"), function(object) {
...
#' the hypergeometric results class
#'
...
hypergeometric_result <- setClass(
  ...
  contains = "enriched_result"
)

#' the gsea results class
#'
...
#'
#' @export
#' @return hypergeometric_result
#' @rdname enriched_result
hypergeometric_result <- function(features, universe, annotation, statistics) {
...
#'
#' @export
significant_annotations <- setClass(
...
#' @exportMethod show
#' @rdname cc_graph
setMethod("show", signature = list(object = "cc_graph"), function(object) {
...
#'
#' @exportMethod show
setMethod("show", signature = list(object = "node_assign"), function(object) {
